...
export function DashboardSidebar() {
  ...
  const othersMenuItems: MenuItem[] = [
    ...
    },
    {
      ...
      url: "mailto:joyduliajan@gmail.com",
      icon: Headphones,
    },
  ];
  ...
  return (
    <Sidebar collapsible="icon">
      <SidebarHeader className="flex flex-col gap-4 pt-4">
        <div className="flex items-center gap-2 pl-1 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:p-0">
          <Image
            src="/logo.svg"
            alt="resonance"
            width={24}
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <OrganizationSwitcher
              hidePersonal
              fallback={
                <Skeleton className="h-8.5 w-full group-data-[collapsible=icon]:size-8 rounded-md bg-[#fafafa]" />
              }
              appearance={{
                elements: {
                  rootBox:
                  ...
                  organizationSwitcherTrigger:
                    "w-full! justify-between! bg-white! border! border-border! rounded-md! pl-1! pr-2! py-1! gap-3! group-data-[collapsible=icon]:w-auto! group-data-[collapsible=icon]:p-1! group-data-[collapsible=icon]:justify-center! shadow-[0px_1px_1.5px_0px_rgba(44,54,53,0.03)!,inset_0px_0px_0px_2px_white]",
      ...
      <div className="border-b border-s-accent border-border" />
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <UserButton
              showName
              fallback={
                <Skeleton className="h-9.5 w-full group-data-[collapsible=icon]:size-8 rounded-md bg-[#fafafa]" />
              }
              appearance={{
                elements: {
                  rootBox:
