...
const SettingsPanel = () => {
  return (
    <div className="hidden w-105 min-h-0 flex-col border-l lg:flex">
      ...
      >
        <TabsList className="w-full bg-transparent rounded-none border-b h-1/2 group-data-[orientation=horizontal]/tabs:h-12 p-0">
        ...
        <TabsContent
          value="settings"
          className="mt-0 min-h-0 flex flex-col overflow-y-auto"
        >
